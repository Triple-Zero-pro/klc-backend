...
Route::group(['middleware' => 'auth:admins', 'prefix' => 'admin/dashboard', 'as' => 'dashboard.'], function () {
    ...
    Route::get('categories_statistics/{time}', [DashServicesController::class, 'categories_statistics']);
    Route::get('services_by_categories_statistics/{cat_id}/{time}', [DashServicesController::class, 'services_by_categories_statistics']);
